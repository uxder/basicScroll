...
var getScrollTop = function getScrollTop() {
  ...
  if (window['BasicScrollTop']) {
    ...
    window['BasicScrollTop'] = scrollTop; // Wait for a single scroll to clear the cache.
...
var create = function create(data) {
  ...
  var _data = null; // Returns the parsed and calculated data
  ...
  var previousScrollTop = null; // Update props

  var _update = function _update() {
    var currentScrollTop = getScrollTop();

    if (currentScrollTop !== previousScrollTop) {
      var _getProps = getProps(instance, currentScrollTop),
          elem = _getProps.elem,
  ...
  var instance = {
    ...
    update: _update,
    destroy: _destroy // Store instance in global array and save the index
